...
<head>
  ...
  <title><?= e(__('error.500.title')) ?> — <?= e(__('app.name')) ?></title>
  ...
  <div class="d-flex align-items-center justify-content-center" style="min-height: 100vh; padding: 24px;">
    <div class="text-center" style="max-width: 460px;">
      <div class="d-inline-flex align-items-center justify-content-center mb-4"
           style="width: 88px; height: 88px; border-radius: 50%; background: var(--n-danger-soft); color: var(--n-danger);">
        <?= icon('alert-triangle', 'n-icon-xl') ?>
      </div>
      <h1 class="h3 mb-2"><?= e(__('error.500.title')) ?></h1>
      <p class="text-muted mb-4"><?= e(__('error.500.body', ['ref' => $ref ?? '-'])) ?></p>
